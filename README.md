...
`SCOPE.CTN` requires R $geq$ 4.4.0 and supports Windows, macOS, and Linux. You can install `SCOPE.CTN` directly from GitHub:
...
Documentation and tutorials can be found at https://yufanwu147.github.io/SCOPE.CTN/. 

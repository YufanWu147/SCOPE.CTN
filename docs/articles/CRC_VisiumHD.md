...
(LA)-like niches** characterized by the B cell/CD4\\^+\\ T
cell/CD8\\^+\\ T cell triad in the colorectal cancer (CRC) VisiumHD data
using SCOPE. The dataset comes from [Oliveira et al. *Nat Genet*
...
#> [21] FNN_1.1.4.1        textshaping_1.0.5  litedown_0.9       htmltools_0.5.9   
#> [25] sass_0.4.10        yaml_2.3.12        gmp_0.7-5.1        pillar_1.11.1     
#> [29] pkgdown_2.2.0      jquerylib_0.1.4    cachem_1.1.0       nlme_3.1-164      
#> [33] commonmark_2.0.0   tidyselect_1.2.1   digest_0.6.39      stringi_1.8.7     
#> [37] labeling_0.4.3     splines_4.4.1      fastmap_1.2.0      grid_4.4.1        
#> [41] cli_3.6.5          magrittr_2.0.4     survival_3.6-4     withr_3.0.2       
#> [45] scales_1.4.0       timechange_0.4.0   rmarkdown_2.30     otel_0.2.0        
#> [49] ragg_1.5.1         hms_1.1.4          evaluate_1.0.5     knitr_1.51        
#> [53] irlba_2.3.7        markdown_2.0       mgcv_1.9-3         rlang_1.1.7       
#> [57] gridtext_0.1.5     Rcpp_1.1.1         glue_1.8.0         xml2_1.5.2        
#> [61] rstudioapi_0.18.0  jsonlite_2.0.0     R6_2.6.1           ClusterR_1.3.3    
#> [65] systemfonts_1.3.1  fs_1.6.7
```

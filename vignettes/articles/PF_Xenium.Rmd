...
Next, we apply SCOPE to the B cell/CD4$^+$ T cell/CD8$^+$ T cell triad using default configurations for the following parameters:
...
Here we can see that the B cell/CD4$^+$ T cell/CD8$^+$ T cell CTNs closely aligns with the lymphocyte aggregates in the CRC samples, where CTN1 resembles the B cell zone and CTN2 resembles the surrounding T cell zone.

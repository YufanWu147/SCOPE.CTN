...
Below are two example CTNs associated with the disease-free survival. One is B cell/CD4$^+$ T cell/CD8$^+$ T cell, which resembles the lymphocyte aggregates.
...
```
The other is blood endothelial (BEC)/CD4$^+$ T cell/CD8$^+$ T cell, which preferentialy co-localized with normoxic tumor cells compared to hypoxic tumor cells.

...
data_path <- "vignette_data/"         # !!! Change this line to your own directory
source(paste0(data_path, "palettes/", 
              dataset_name, "_celltype_palette.R")) # cell type color palette
```
